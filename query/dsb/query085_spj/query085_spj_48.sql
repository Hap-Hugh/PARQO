...
WHERE ws_web_page_sk = wp_web_page_sk
  ...
  AND ((ca_country = 'United States' AND ca_state in ('IN', 'MS', 'NC')
        AND ws_net_profit BETWEEN 100 AND 200)
       OR (ca_country = 'United States' AND ca_state in ('GA', 'MO', 'TX')
           AND ws_net_profit BETWEEN 150 AND 300)
       OR (ca_country = 'United States' AND ca_state in ('AL', 'CO', 'GA')
