...
AND i_category IN ('Electronics', 'Jewelry', 'Shoes')
...
AND ca_state in ('IA', 'MN', 'MO', 'ND', 'SC')
AND d1.d_year = 2000
AND hd_income_band_sk BETWEEN 3 AND 9
AND hd_buy_potential = '1001-5000'
AND ss_sales_price / ss_list_price BETWEEN 52 * 0.01 AND 72 * 0.01
;
