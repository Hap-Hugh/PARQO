...
where
    ...
    and s_state = w_state
    AND i_category IN ('Electronics', 'Music', 'Shoes')
    and i_manager_id IN (8, 54, 64, 67, 71, 72, 75, 77, 81, 95)
    and c_current_cdemo_sk = cd_demo_sk
    and c_current_hdemo_sk = hd_demo_sk
    and c_current_addr_sk = ca_address_sk
    and ca_state in ('FL', 'GA', 'NY', 'SC', 'TX')
    and d1.d_year = 2000
    and ws_wholesale_cost BETWEEN 7 AND 27
    ;
